...
pub const SurfaceBackgroundVideoDialog = extern struct {
    const Self = @This();
    parent_instance: Parent,
    pub const Parent = adw.AlertDialog;
    pub const getGObjectType = gobject.ext.defineClass(Self, .{
        .name = "GhosttySurfaceBackgroundVideoDialog",
        .instanceInit = &init,
    ...
    fn alertDialogReady(
        ...
        const value = std.mem.span(self.private().entry.getBuffer().getText());
        ...
        fn init(class: *Class) callconv(.c) void {
            gtk.Widget.Class.setTemplateFromResource(
                ...
                comptime gresource.blueprint(.{
                    .major = 1,
                    .minor = 5,
                    .name = "surface-background-video-dialog",
                }),
            );
